<form id="editConflict" method="post" action={concat( '/content/edit/', $object.id, '/', $current_version, '/', $edit_language, '/', $edit_language )|ezurl}>
<div class="modal-header">
    <input class="close" type="submit" name="DiscardButton" value="×">
    <h4 class="modal-title"><span class="time">[{currentdate()|l10n( shortdatetime )}]</span> {'Possible edit conflict'|i18n( 'design/admin/content/edit_draft' )}</h4>
</div>
...
<div class="modal-footer">
    <input class="btn btn-primary" type="submit" name="PublishButton" value="{'Publish data'|i18n( 'design/admin/content/edit' )}" title="{'Publish the contents of the draft that is being edited. The draft will become the published version of the object.'|i18n( 'design/admin/content/edit' )}" />
    <input class="btn" type="submit" name="ShowPublishedData" value="{'Show the published data'|i18n( 'design/admin/content/edit_draft' )}" title="{'Create a new draft. The contents of the new draft will be copied from the published version.'|i18n( 'design/admin/content/edit_draft' )}" />
</div>
</form>

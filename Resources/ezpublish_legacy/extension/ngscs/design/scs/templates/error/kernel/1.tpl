<div class="alert alert-warning">
    <h4 class="alert-heading">{"Login is required"|i18n("eregistry_armenia/error/kernel")}</h4>
...
{if eq($current_user.contentobject_id,$anonymous_user_id)}
    ...
    {else}
        ...
        <input class="btn btn-primary" type="submit" name="LoginButton" value="{'Login'|i18n('design/standard/error/kernel','Button')}" />

    ...
    <div class="ezcom-add">
        ...
        {if $fields|contains( 'title' )}
            {def $titleRequired = ezini( 'title', 'Required', 'ezcomments.ini' )|eq( 'true' )}
                <div class="form-group ezcom-field ezcom-field-title">
                    <label for="CommentTitle" class="control-label">{'Title:'|i18n( 'ezcomments/comment/add/form' )}{if $titleRequired}{$fieldRequiredText}{/if}</label>
                    <div class="controls">
                        <input type="text" id="CommentTitle" class="form-control" maxlength="100" name="CommentTitle" />
                    </div>
                </div>
            {undef $titleRequired}
        {/if}
        ...
        {if $fields|contains( 'name' )}
            {def $nameRequired = ezini( 'name', 'Required', 'ezcomments.ini' )|eq( 'true' )}
                <div class="form-group ezcom-field ezcom-field-name">
                    ...
                    <label for="CommentName" class="control-label">{'Name:'|i18n( 'ezcomments/comment/add/form' )}{if $nameRequired}{$fieldRequiredText}{/if}</label>
                    <div class="controls">
        ...
        {if $fields|contains( 'website' )}
            {def $websiteRequired = ezini( 'website', 'Required', 'ezcomments.ini' )|eq( 'true' )}
                <div class="form-group ezcom-field ezcom-field-website">
                    <label for="CommentWebsite" class="control-label">{'Website:'|i18n( 'ezcomments/comment/add/form' )}{if $websiteRequired}{$fieldRequiredText}{/if}</label>
                    <div class="controls">
        ...
        {if $fields|contains( 'email' )}
            {def $emailRequired = ezini( 'email', 'Required', 'ezcomments.ini' )|eq( 'true' )}
                <div class="form-group ezcom-field ezcom-field-email">
                    <label for="CommentEmail" class="control-label">
        ...
        <div class="form-group ezcom-field ezcom-field-content">
            <label for="CommentContent" class="control-label">{'Content:'|i18n( 'ezcomments/comment/add/form' )}{$fieldRequiredText}</label>
        ...
        {/if}
        <div class="ezcom-field">
            <input type="submit" value="{'Add comment'|i18n( 'ezcomments/comment/add/form' )}" class="btn btn-success" name="AddCommentButton" />
            <input type="reset" class="btn btn-warning" value="{'Reset form'|i18n( 'ezcomments/comment/add/form' )}" />
        </div>
    </div>
</form>

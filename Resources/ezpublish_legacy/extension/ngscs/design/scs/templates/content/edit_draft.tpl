...
<div class="row">
    ...
    <div class="col-lg-11 col-sm-10">
        ...
        <form method="post" action={concat('content/edit/',$object.id,'/',$edit_language,'/',$from_language)|ezurl} id="draft">
        ...
        {if and($has_own_drafts,$has_other_drafts)}
            <input class="btn btn-danger" type="submit" name="EditButton" value="{'Edit'|i18n('design/standard/content/edit')}" />
            <input class="btn btn-primary" type="submit" name="NewDraftButton" value="{'New draft'|i18n('design/standard/content/edit')}" />
        {else}
            {if $has_own_drafts}
                <input class="btn btn-danger" type="submit" name="EditButton" value="{'Edit'|i18n('design/standard/content/edit')}" />
                <input class="btn btn-primary" type="submit" name="NewDraftButton" value="{'New draft'|i18n('design/standard/content/edit')}" />

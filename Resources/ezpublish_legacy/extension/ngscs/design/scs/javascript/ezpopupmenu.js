...
*/
function ezpopmenu_submitForm( formID, customSubstitute, targetElementName )
{
    ...
    if ( formElement )
    {
        ...
        {
          if ( document.getElementsByName(targetElementName).length)
          {
           document.getElementsByName(targetElementName)[0].click();
          }
        }
        else
        {
